...
Page.prototype.add = function (outputResults) {
    if (outputResults.js) {
        if (typeof outputResults.js !== 'object') {
            outputResults.js = [outputResults.js];
        }
        this.js = _.union(this.js,outputResults.js);
    }

    if (outputResults.css) {
        if (typeof outputResults.css !== 'object') {
            outputResults.css = [outputResults.css];
        }
        this.css = _.union(this.css,outputResults.css);
    }
};
