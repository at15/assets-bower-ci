...
output.writeJson = function () {
    var strPages = JSON.stringify(output.toObject(), null, 4);
...
output.writeUncompressed = function (files) {
    ...
    return {
        js: fh.split(files, 'js'),
        css: fh.split(files, 'css')
    };
};
